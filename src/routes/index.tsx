...
function Home() {
  ...
  return (
    <main>
      ...
      {/* Hero */}
      <header className="relative w-full min-h-[760px] overflow-hidden flex flex-col justify-center pt-24 md:pt-6">
        <div
      ...
      <section className="bg-primary-soft/40 border-b border-border"><div className="mx-auto max-w-7xl px-6 md:px-16 py-20 md:py-28">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">September 5th</p>
          </article>
          <article
            className="border border-border p-8 hover:border-foreground transition-colors group"
            data-aos="fade-up"
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              ...
              upcoming trail projects on the mountain. Grizzly Den — 20753 Mount Keenan Road, Date:
              TBD
            </p>
          </article>
          <article
